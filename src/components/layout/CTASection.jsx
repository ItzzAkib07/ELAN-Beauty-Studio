...
export default function CTASection({
  title = "Your Moment. Your Beauty. Your ÉLAN.",
  ...
  return (
    <section className={`relative py-20 sm:py-28 overflow-hidden bg-gradient-to-b from-[#14100E] via-[#1E1815] to-[#14100E] border-t border-b border-[#C5A880]/20 ${className}`}>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center z-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C5A880]/10 border border-[#C5A880]/30 text-[#E5C590] text-xs uppercase tracking-widest mb-6">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs text-[#A8A19A] tracking-wider uppercase">
