    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {educationCredentials.map((edu) => (
          <div
            key={edu.credential}
            className="p-6 sm:p-7 rounded-sm bg-[#1E1815] border border-[#C5A880]/20 hover:border-[#C5A880]/45 transition-all shadow-md group"
          >
      ...
      <div className="p-6 rounded-sm bg-[#1A1412] border border-[#C5A880]/20 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          {spokenLanguages.map((lang) => (
            <div
              key={lang.language}
              className="px-3.5 py-1.5 rounded-full bg-[#14100E] border border-[#C5A880]/30 text-xs flex items-center gap-2"
            >
